...
const socials = [
  ...
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/in/ayushpatra11',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: 'Twitter',
    href: 'https://twitter.com/ayushpatra11',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
...
export default function Footer() {
  return (
    <footer className="relative z-10 border-t border-slate-800/60 py-16 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div>
            ...
            <p className="text-slate-500 text-sm mt-2 font-mono">
              ayushpatra11@gmail.com · Manchester, UK
            </p>
          </div>
          ...
          {/* Right */}
          <p className="text-slate-600 font-mono text-xs text-center md:text-right">
        ...
        <div className="mt-10 pt-6 border-t border-slate-800/40 text-center">
          <p className="text-slate-700 font-mono text-xs">
            © {new Date().getFullYear()} Ayush Patra. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
